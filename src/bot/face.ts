...
export const FEATURE_SIZE_SCALES: Record<FeatureSize, number> = {
  small: 0.72,
  medium: 1.0,
  large: 1.3
}

export type EyebrowsStyle = 'none' | 'arched' | 'straight' | 'dots'
export const EYEBROWS_STYLES: EyebrowsStyle[] = ['none', 'arched', 'straight', 'dots']
export const DEFAULT_EYEBROWS: EyebrowsStyle = 'none'

export type NoseStyle = 'none' | 'dot' | 'pill' | 'snout'
export const NOSE_STYLES: NoseStyle[] = ['none', 'dot', 'pill', 'snout']
export const DEFAULT_NOSE: NoseStyle = 'none'

export type CheeksStyle = 'none' | 'blush' | 'dots' | 'lines'
export const CHEEKS_STYLES: CheeksStyle[] = ['none', 'blush', 'dots', 'lines']
export const DEFAULT_CHEEKS: CheeksStyle = 'none'

export type MouthStyle = 'none' | 'smile' | 'grin' | 'frown' | 'open' | 'cat' | 'straight'
export const MOUTH_STYLES: MouthStyle[] = ['none', 'smile', 'grin', 'frown', 'open', 'cat', 'straight']
export const DEFAULT_MOUTH: MouthStyle = 'none'
